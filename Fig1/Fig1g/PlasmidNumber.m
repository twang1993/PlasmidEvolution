...
saveas(gcf,'PlasmidNumber.fig');
saveas(gcf,'PlasmidNumber.pdf');
%%%%%%%%%%%%%%
figure(2);
plot(data,(ttt),'ko','markersize',3);hold on;
xlabel('host chromosome size','fontsize',14);
ylabel('plasmid number','fontsize',14);
set(gcf,'position',[100 100 210 200]);
saveas(gcf,'PlasmidNumber_2.fig');
saveas(gcf,'PlasmidNumber_2.pdf');
