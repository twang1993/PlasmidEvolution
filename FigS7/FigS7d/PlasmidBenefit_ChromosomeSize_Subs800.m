...
clc;
close all;
num_meta=800;% number of subtances

NUMGENEs=[1000:5000:50000]-num_meta/4;
REP=5;
Plas=1000;
...
saveas(gcf,'PlasmidBenefit_ChromosomeSize_Subs800.fig');
exportgraphics(gcf,'PlasmidBenefit_ChromosomeSize_Subs800.pdf');
