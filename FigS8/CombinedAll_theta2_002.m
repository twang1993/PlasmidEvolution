...
saveas(gcf,'CombinedAll_1_theta2_002.fig');
saveas(gcf,'CombinedAll_1_theta2_002.pdf');
...
set(gcf,'position',[100 100 210 200]);
saveas(gcf,'CombinedAll_2_theta2_002.fig');
saveas(gcf,'CombinedAll_2_theta2_002.pdf');
...
set(gcf,'position',[100 100 210 200]);
saveas(gcf,'CombinedAll_3_theta2_002.fig');
saveas(gcf,'CombinedAll_3_theta2_002.pdf');
